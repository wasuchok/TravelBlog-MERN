...
export const getBlogPostsByCategory = (category, pageItems) => async (dispatch) => {
    ...
    try {
        const  {data, status}  = await axios.get(`${import.meta.env.VITE_API}/blog-posts/${category}/${pageItems}`)
...
export const getBlogPost = (id) => async (dispatch) => {
    ...
    try {
        ...
        const {data} = await axios.get(`${import.meta.env.VITE_API}/blog-posts/post/${id}`)
...
export const createNewBlogPost = (newPost) => async (dispatch,getState) => {
    ...
    try {
        const config = {
          ...
          await axios.post(`${import.meta.env.VITE_API}/blog-posts`, newPost, config)
...
export const updatePost = (updatePost) => async (dispatch, getState) => {
    ...
    try {
        const config = {
          ...
          await axios.put(`${import.meta.env.VITE_API}/blog-posts`, updatePost, config)
...
export const removePost = (_id) => async (dispatch, getState) => {
    ...
    try {
        const config = {
         ...
         const { data } =  await axios.delete(`${import.meta.env.VITE_API}/blog-posts/${_id}`, config)
          dispatch(setBlogPostByCategory(data))
